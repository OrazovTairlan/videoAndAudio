...
class Store {
    ...
    getDescription = async () => {
        const result = await axios.get("/api/testDescription/testDescription");
        this.descriptionsData = result.data;
        console.log(result);
    };
    getQuestions = async () => {
        const result = await axios.get("/api/testQuestions/testQuestions");
